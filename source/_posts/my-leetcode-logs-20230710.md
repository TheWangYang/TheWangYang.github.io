 ...
 */
class Solution {
    public TreeNode huisu(TreeNode root1, TreeNode root2){
        if(root1 == null){
            return root2;
        }
        ...
        root1.val += root2.val;
        root1.left = huisu(root1.left, root2.left);
        root1.right = huisu(root1.right, root2.right);

        return root1;
    }    
    
    public TreeNode mergeTrees(TreeNode root1, TreeNode root2) {
        return huisu(root1, root2);
    }
}
```
